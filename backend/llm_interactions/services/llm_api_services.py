...
async def _call_openai(prompt: str, model: str, api_key: str) -> str:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Unexpected error calling OpenAI: {e}")
...
async def _call_anthropic(prompt: str, model: str, api_key: str) -> str:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Unexpected error calling Anthropic: {e}")
...
async def _call_google(prompt: str, model: str, api_key: str) -> str:
    ...
    try:
        ...
        raise HTTPException(status_code=504, detail="Google request timed out")
    except httpx.RequestError as e:
        raise HTTPException(status_code=502, detail=f"Google connection error: {e}")
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Unexpected error calling Google: {e}")
...
async def _call_generic(prompt: str, model: str | None, api_key: str, endpoint: str | None) -> str:
    ...
    try:
        ...
        raise HTTPException(status_code=504, detail="Generic provider request timed out")
    except httpx.RequestError as e:
        raise HTTPException(status_code=502, detail=f"Generic provider connection error: {e}")
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Unexpected error calling generic provider: {e}")
...
async def run_api_llm(body: LLMPromptRequest) -> LLMPromptResponse:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Unexpected error in run_api_llm: {e}")
